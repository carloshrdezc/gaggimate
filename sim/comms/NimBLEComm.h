// Simulator stand-in for lib/NimBLEComm/src/NimBLEComm.h. Provides the protocol
// vocabulary the firmware uses (callback typedefs, SystemInfo/SystemCapabilities)
// WITHOUT the NimBLE/Arduino-BLE dependency — the simulator has no Bluetooth, so
// the real client is replaced by the NimBLEClientController mock. [CAR-399]
#ifndef NIMBLECOMM_H
#define NIMBLECOMM_H
...
// Error codes are defined in GaggiMateComm.h (as int, matching the device
// protocol); don't redeclare them here with a different type.
